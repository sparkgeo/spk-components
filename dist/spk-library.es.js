...
import { faTrash as rt, faFilter as tt, faInfo as nt, faFillDrip as at, faEllipsisVertical as ot, faChevronRight as wr, faChevronLeft as it, faArrowsLeftRight as st, faCalendar as ct, faChevronDown as lt } from "@fortawesome/free-solid-svg-icons";
import { Slider as ut, Label as Pr, SliderTrack as ft, SliderThumb as dt, DatePicker as pt, Group as vt, DateInput as yt, DateSegment as ht, Button as Me, Text as mt, FieldError as vr, Popover as _t, Dialog as bt, Calendar as gt, Heading as Tt, CalendarGrid as xt, CalendarCell as Et } from "react-aria-components";
...
function St() {
  if (yr) return Te;
  yr = 1;
  var r = Or, d = Symbol.for("react.element"), f = Symbol.for("react.fragment"), c = Object.prototype.hasOwnProperty, v = r.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner, p = { key: !0, ref: !0, __self: !0, __source: !0 };
  function g(y, h, R) {
    var m, T = {}, $ = null, q = null;
...
function Ot() {
  return hr || (hr = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    var x = B.ReactCurrentDispatcher, E;
    function S(e, t, i) {
      {
        if (E === void 0)
          try {
...
` + w[G].replace(" at new ", " at ");
        ...
        k = !1, x.current = L, P(), Error.prepareStackTrace = I;
      }
    ...
    function ar(e) {
      if (Dr(e))
        return F("The provided key is an unsupported type %s. This value must be coerced to a string before before using it here.", Nr(e)), nr(e);
    }
    ...
    function Gr(e, t, i, _, I) {
      {
        var L, A = {}, w = null, J = null;
        i !== void 0 && (ar(i), w = "" + i), Wr(t) && (ar(t.key), w = "" + t.key), Lr(t) && (J = t.ref, qr(t, I));
        for (L in t)
          be.call(t, L) && !Mr.hasOwnProperty(L) && (A[L] = t[L]);
        if (e && e.defaultProps) {
        ...
        return Br(e, w, J, I, _, ge.current, A);
      }
    }
...
React keys must be passed directly to JSX without using spread:
  let props = %s;
  <%s key={someKey} {...props} />`, De, se, Qr, se), dr[se + De] = !0;
          }
        }
        return e === c ? Hr(U) : zr(U), U;
      }
    }
    function Jr(e, t, i) {
      return pr(e, t, i, !0);
    ...
    var Xr = Kr, Zr = Jr;
    xe.Fragment = c, xe.jsx = Xr, xe.jsxs = Zr;
  }()), xe;
}
process.env.NODE_ENV === "production" ? He.exports = St() : He.exports = Ot();
...
var br;
function Ar() {
  return br || (br = 1, process.env.NODE_ENV === "production" ? je.exports = wt() : je.exports = Pt()), je.exports;
}
/*
object-assign
(c) Sindre Sorhus
...
function At() {
  ...
  return Le = v() ? Object.assign : function(p, g) {
...
var qe, xr;
function kr() {
  return xr || (xr = 1, qe = Function.call.bind(Object.prototype.hasOwnProperty)), qe;
}
var Fe, Er;
function kt() {
  if (Er) return Fe;
...
function $t() {
  if (Cr) return Ye;
  Cr = 1;
  var r = Ar(), d = At(), f = Xe(), c = kr(), v = kt(), p = function() {
  };
  ...
  return Ye = function(y, h) {
    ...
    function V(n) {
      ...
      function C(P, x, E, S, k, O, H) {
        ...
        return x[E] == null ? P ? x[E] === null ? new W("The " + k + " `" + O + "` is marked as required " + ("in `" + S + "`, but its value is `null`.")) : new W("The " + k + " `" + O + "` is marked as required in " + ("`" + S + "`, but its value is `undefined`.")) : null : n(x, E, S, k, O);
      }
      var b = C.bind(null, !1);
      return b.isRequired = C.bind(null, !0), b;
    }
    function B(n) {
      function u(j, C, b, P, x, E) {
        var S = j[C], k = Q(S);
        if (k !== n) {
          var O = te(S);
          return new W(
            "Invalid " + P + " `" + x + "` of type " + ("`" + O + "` supplied to `" + b + "`, expected ") + ("`" + n + "`."),
            { expectedType: n }
          );
        }
        return null;
    ...
    function M(n) {
      function u(j, C, b, P, x) {
        if (typeof n != "function")
          return new W("Property `" + x + "` of component `" + b + "` has invalid PropType notation inside arrayOf.");
        var E = j[C];
        if (!Array.isArray(E)) {
          var S = Q(E);
          return new W("Invalid " + P + " `" + x + "` of type " + ("`" + S + "` supplied to `" + b + "`, expected an array."));
        }
        for (var k = 0; k < E.length; k++) {
          var O = n(E, k, b, P, x + "[" + k + "]", f);
    ...
    function Y() {
      function n(u, j, C, b, P) {
        var x = u[j];
        if (!y(x)) {
          var E = Q(x);
          return new W("Invalid " + b + " `" + P + "` of type " + ("`" + E + "` supplied to `" + C + "`, expected a single ReactElement."));
        }
        return null;
      }
      return V(n);
    ...
    function l() {
      function n(u, j, C, b, P) {
        var x = u[j];
        if (!r.isValidElementType(x)) {
          var E = Q(x);
          return new W("Invalid " + b + " `" + P + "` of type " + ("`" + E + "` supplied to `" + C + "`, expected a single ReactElement type."));
        }
        return null;
      }
      return V(n);
    ...
    function ne(n) {
      function u(j, C, b, P, x) {
        if (!(j[C] instanceof n)) {
          var E = n.name || $, S = fe(j[C]);
          return new W("Invalid " + P + " `" + x + "` of type " + ("`" + S + "` supplied to `" + b + "`, expected ") + ("instance of `" + E + "`."));
        }
        return null;
      }
      return V(u);
    ...
    function he(n) {
      ...
      function u(j, C, b, P, x) {
        for (var E = j[C], S = 0; S < n.length; S++)
          if (z(E, n[S]))
            return null;
        ...
        return new W("Invalid " + P + " `" + x + "` of value `" + String(E) + "` " + ("supplied to `" + b + "`, expected one of " + k + "."));
      }
      return V(u);
    }
    function me(n) {
      function u(j, C, b, P, x) {
        if (typeof n != "function")
          return new W("Property `" + x + "` of component `" + b + "` has invalid PropType notation inside objectOf.");
        var E = j[C], S = Q(E);
        if (S !== "object")
          return new W("Invalid " + P + " `" + x + "` of type " + ("`" + S + "` supplied to `" + b + "`, expected an object."));
        for (var k in E)
          if (c(E, k)) {
            var O = n(E, k, b, P, x + "." + k, f);
            if (O instanceof Error)
    ...
    function ce(n) {
      ...
      function C(b, P, x, E, S) {
        for (var k = [], O = 0; O < n.length; O++) {
          var H = n[O], o = H(b, P, x, E, S, f);
          if (o == null)
            return null;
          o.data && c(o.data, "expectedType") && k.push(o.data.expectedType);
        }
        var ee = k.length > 0 ? ", expected one of type [" + k.join(", ") + "]" : "";
        return new W("Invalid " + E + " `" + S + "` supplied to " + ("`" + x + "`" + ee + "."));
      }
      return V(C);
    }
    function _e() {
      function n(u, j, C, b, P) {
        return X(u[j]) ? null : new W("Invalid " + b + " `" + P + "` supplied to " + ("`" + C + "`, expected a ReactNode."));
      }
      return V(n);
    }
    function le(n, u, j, C, b) {
      return new W(
        (n || "React class") + ": " + u + " type `" + j + "." + C + "` is invalid; it must be a function, usually from the `prop-types` package, but received `" + b + "`."
      );
    }
    function ue(n) {
      function u(j, C, b, P, x) {
        var E = j[C], S = Q(E);
        if (S !== "object")
          return new W("Invalid " + P + " `" + x + "` of type `" + S + "` " + ("supplied to `" + b + "`, expected `object`."));
        for (var k in n) {
          var O = n[k];
          if (typeof O != "function")
            return le(b, P, x, k, te(O));
          var H = O(E, k, b, P, x + "." + k, f);
          if (H)
            return H;
        }
        return null;
      ...
      function u(j, C, b, P, x) {
        ...
        for (var O in k) {
          ...
          if (c(n, O) && typeof H != "function")
            return le(b, P, x, O, te(H));
          if (!H)
            return new W(
              "Invalid " + P + " `" + x + "` key `" + O + "` supplied to `" + b + "`.\nBad object: " + JSON.stringify(j[C], null, "  ") + `
Valid keys: ` + JSON.stringify(Object.keys(n), null, "  ")
            );
          var o = H(E, O, b, P, x + "." + O, f);
          if (o)
            return o;
        }
        return null;
...
if (process.env.NODE_ENV !== "production") {
  ...
  Je.exports = It()();
var Mt = Je.exports;
const s = /* @__PURE__ */ jt(Mt), Lt = "_iconButton_1963e_1", Wt = {
  iconButton: Lt
}, qt = {
  trash: rt,
  filter: tt,
  ...
  chevronRight: wr,
  chevronLeft: it
}, Pe = ({ onClick: r, iconName: d }) => /* @__PURE__ */ a.jsx("div", { className: Wt.iconButton, children: /* @__PURE__ */ a.jsx("button", { "aria-label": d, type: "button", onClick: r, children: /* @__PURE__ */ a.jsx(we, { icon: qt[d] }) }) });
Pe.propTypes = {
  iconName: s.oneOf([
    "trash",
    "filter",
...
const Ft = "_layerButtonReel_1o59k_1", Yt = {
  layerButtonReel: Ft
}, Ze = ({ buttons: r }) => /* @__PURE__ */ a.jsx("div", { className: Yt.layerButtonReel, children: r && Object.keys(r).map((d) => /* @__PURE__ */ a.jsx(Pe, { iconName: d, onClick: r[d] })) });
Ze.propTypes = {
...
const Bt = "_layerToggle_gvlf4_7", Gt = "_slider_gvlf4_29", Ge = {
  layerToggle: Bt,
...
const en = "_swatchContainer_771fp_2", rn = "_swatch_771fp_2", tn = "_swatchLabel_771fp_18", nn = "_swatchValue_771fp_24", Se = {
  swatchContainer: en,
  swatch: rn,
  swatchLabel: tn,
  swatchValue: nn
}, an = ({ color: r, label: d = "", value: f, units: c = "" }) => /* @__PURE__ */ a.jsxs("div", { className: Se.swatchContainer, children: [
  /* @__PURE__ */ a.jsx(
    "div",
    {
      "data-testid": "swatch",
...
const ln = "_slider_1bnet_1", un = "_sliderLabel_1bnet_16", fn = "_sliderThumb_1bnet_20", dn = "_sliderTrack_1bnet_41", pn = "_comparisonControl_1bnet_66", Ee = {
  slider: ln,
  sliderLabel: un,
  sliderThumb: fn,
  sliderTrack: dn,
  ...
  value: c = 50,
  ...v
}) => /* @__PURE__ */ a.jsx("div", { className: Ee.comparisonControl, children: /* @__PURE__ */ a.jsxs(ut, { maxValue: 94, minValue: 6, step: 0.1, className: Ee.slider, "aria-label": !d && typeof r == "string" ? r : void 0, onChange: f, value: c, ...v, children: [
  d && /* @__PURE__ */ a.jsx(Pr, { className: Ee.sliderLabel, children: r }),
  /* @__PURE__ */ a.jsx(ft, { className: Ee.sliderTrack, children: /* @__PURE__ */ a.jsx(dt, { className: Ee.sliderThumb, children: /* @__PURE__ */ a.jsx(we, { color: "white", icon: st }) }) })
] }) }), vn = "_datePicker_72xgm_1", yn = "_dateInput_72xgm_11", hn = "_hoverDatepicker_72xgm_19", Ve = {
  datePicker: vn,
  dateInput: yn,
  hoverDatepicker: hn
}, Ue = (r) => new Rt(r.getFullYear(), r.getMonth() + 1, r.getDate()), zn = ({
  label: r,
  helperText: d,
  errorMessage: f,
  value: c,
  ...
  const [T, $] = Ke(!1), { hoverProps: q, isHovered: z } = Ct({}), W = c ? Ue(c) : null, V = h ? Ue(h) : null, B = R ? Ue(R) : null, F = (M) => {
    if (M) {
      const Y = new Date(M.toString());
      v(Y);
    } else
      v(null);
  };
      ...
      children: [
        ...
        /* @__PURE__ */ a.jsxs(vt, { children: [
          /* @__PURE__ */ a.jsx(
            yt,
            {
              ...
              ...q,
              children: (M) => /* @__PURE__ */ a.jsx(ht, { segment: M })
            }
          ),
          /* @__PURE__ */ a.jsx(
            Me,
            {
              ...
              onHoverChange: (M) => $(M),
              children: /* @__PURE__ */ a.jsx(we, { icon: ct })
            }
          )
        ] }),
        ...
        /* @__PURE__ */ a.jsx(_t, { children: /* @__PURE__ */ a.jsx(bt, { children: /* @__PURE__ */ a.jsxs(gt, { children: [
          /* @__PURE__ */ a.jsxs("header", { children: [
            /* @__PURE__ */ a.jsx(Me, { slot: "previous", children: "◀" }),
            /* @__PURE__ */ a.jsx(Tt, {}),
            /* @__PURE__ */ a.jsx(Me, { slot: "next", children: "▶" })
          ] }),
          /* @__PURE__ */ a.jsx(xt, { children: (M) => /* @__PURE__ */ a.jsx(Et, { date: M }) })
        ] }) }) })
      ]
    }
  );
}, mn = "_gradient_1w8qh_1", _n = "_gradientNumbers_1w8qh_6", bn = "_gradientLegend_1w8qh_11", Oe = {
  gradient: mn,
  gradientNumbers: _n,
  gradientLegend: bn
}, gn = ({
...
const Tn = "_simpleSlider_qj292_1", xn = "_simpleSliderInput_qj292_7", En = "_simpleSliderMinMaxContainer_qj292_11", ze = {
  simpleSlider: Tn,
  simpleSliderInput: xn,
  simpleSliderMinMaxContainer: En
}, er = ({
  units: r,
  label: d,
  onChange: f,
...
const Cn = "_layerGroupButton_1twxx_1", Rn = "_layerGroupChevron_1twxx_12", jn = "_layerGroupName_1twxx_25", Sn = "_layerGroupWrapper_1twxx_32", On = "_layerGroupChildren_1twxx_32", Ce = {
  layerGroupButton: Cn,
  layerGroupChevron: Rn,
  layerGroupName: jn,
  layerGroupWrapper: Sn,
  layerGroupChildren: On
}, wn = ({ groupName: r, children: d }) => {
  const [f, c] = Ke(!1), v = () => {
    c(!f);
  };
  return /* @__PURE__ */ a.jsxs("div", { className: Ce.layerGroupWrapper, children: [
    /* @__PURE__ */ a.jsxs("button", { type: "button", className: Ce.layerGroupButton, onClick: v, children: [
      /* @__PURE__ */ a.jsx("div", { className: Ce.layerGroupChevron, children: /* @__PURE__ */ a.jsx(we, { size: "md", fixedWidth: !0, icon: f ? lt : wr }) }),
      /* @__PURE__ */ a.jsx("span", { className: Ce.layerGroupName, children: r })
    ] }),
    f && /* @__PURE__ */ a.jsx("div", { className: Ce.layerGroupChildren, children: d })
  ] });
};
wn.propTypes = {
  groupName: s.string,
...
const Pn = "_mapWrapper_1gyf5_1", An = "_mapContainer_1gyf5_10", jr = {
  mapWrapper: Pn,
  mapContainer: An
}, kn = ({ mapContainer: r, id: d, children: f }) => /* @__PURE__ */ a.jsxs("div", { className: jr.mapWrapper, children: [
...
const $n = ({ children: r }) => /* @__PURE__ */ a.jsx("div", { className: "nav-container", children: r });
$n.propTypes = {
  children: s.oneOfType([
    s.arrayOf(s.node),
    s.node
...
const In = ({ showToggle: r, children: d }) => {
...
const Nn = ({ children: r }) => /* @__PURE__ */ a.jsx("div", { className: "layout-stacked", children: r });
Nn.propTypes = {
  children: s.oneOfType([
    s.arrayOf(s.node),
    s.node
...
const Dn = ({ align: r = "left", children: d }) => /* @__PURE__ */ a.jsx("div", { className: `layout-standard ${r}`, children: d });
Dn.propTypes = {
...
const Mn = "_sliderControlWrapper_2tznx_1", Ln = "_sliderLabel_2tznx_9", Sr = {
  sliderControlWrapper: Mn,
  sliderLabel: Ln
}, Wn = ({ title: r, units: d, sliderConfig: f }) => /* @__PURE__ */ a.jsxs("div", { className: Sr.sliderControlWrapper, children: [
  /* @__PURE__ */ a.jsx("div", { className: "ui-label", children: r }),
  /* @__PURE__ */ a.jsx("div", {}),
  f && f.map((c) => {
    const { label: v } = c;
    return /* @__PURE__ */ a.jsx("div", { className: Sr.sliderLabel, children: v });
  }),
  f && f.map((c) => {
